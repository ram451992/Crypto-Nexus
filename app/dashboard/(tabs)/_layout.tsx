...
export default function TabLayout() {
  ...
  return (
      ...
      >
        <TopTabs.Screen name='(tabs)/gainers'  options={{ title: "Top Gainers",tabBarLabel: "Top Gainers"  }} />
        <TopTabs.Screen name='(tabs)/losers' options={{ title: "Top Losers" }} />
        <TopTabs.Screen name='(tabs)/hot' options={{ title: "Hot(24H Vol)" }} />
      </TopTabs>
