...
export default Dashboard = () => {
  ...
  //const renderData = (item ) => {
      ...
      <View style={styles.cryptoItem}>
        ...
        <Text style={styles.text}>{utils.formatVolume(item.usd_24h_vol)}</Text>
  ...
  return (<View style={{ flex: 1 }}>
    <View style={styles.cryptoItem}>
      ...
      <Text style={styles.textGrey}>Volume(24H)</Text>
      <Text style={styles.textGrey}>Change</Text>
    </View>
    {<FlatList data={data.hot.slice(0, 5)} renderItem={renderData} />}
    {/*data.hot.slice(0, 5).map((item, index)=>(renderData(item, index)))*/}
  </View>)
